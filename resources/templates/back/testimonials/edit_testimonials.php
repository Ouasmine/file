            ...
            <div class="page-title-heading">
                ...
                <div>
                    ...
                    <div class="page-title-subheading">
                        By submitting this form, you will update the testimonials
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <?php if($testimonials_result): ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3"> 
                                ...
                                <input type="text" class="form-control" id="validationCustom01" name="full_name" value="<?php echo $tes->full_name ?>" required="" />
                            ...
                            <div class="col-md-6 mb-3"> 
                                ...
                                <input type="hidden" name="testimonials_id" value="<?php echo $tes->id?>">
                                <input type="text" class="form-control" id="validationCustom01" name="role" value="<?php echo $tes->role ?>" />
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
