        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                Add a new event
                    ...
                    By submitting this form you will create a new event
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="" >
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="time" class="form-control" id="validationCustom01" name="start_time" required="" />
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="time" class="form-control" id="validationCustom01" name="end_time" required="" />
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" name="location" required="" />
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
